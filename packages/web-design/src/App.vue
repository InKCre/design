<template>
  <div id="app">
    <h1>InKCre WebDesign Playground</h1>
    ...
    <section style="padding: 20px;">
      ...
      <div style="margin: 20px 0;">
        <h3>inkButton</h3>
        <InkButton text="Subtle Button" type="subtle" @click="handleClick" />
        <InkButton text="Primary Button" type="primary" @click="handleClick" />
        <InkButton text="Danger Button" type="danger" @click="handleClick" />
      </div>
      ...
      <div style="margin: 20px 0;">
        <h3>inkSwitch</h3>
        <InkSwitch v-model="switchValue" label="Enable Feature" />

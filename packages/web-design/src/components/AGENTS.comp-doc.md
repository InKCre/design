...
The words in `>` is for you (agent) to follow.

````md
# CompName

> One-sentence description of the core problem this component solves.
...
> The examples represent canonical usage, not an exhaustive combination of all parameters.
